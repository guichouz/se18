...
public class SearchBar implements EventHandler{
    ...
    public SearchBar(final ComboBox comboBox, Controlleur c) {
        this.comboBox = comboBox;
        this.data = comboBox.getItems();
        this.c=c;

        this.doTestSearchBar();
    }

    public SearchBar(final ComboBox comboBox, Integer sid) {
        this.comboBox = comboBox;
        this.data = comboBox.getItems();
        this.sid = sid;
    ...
    private void doTestSearchBar() {
        ...
        this.comboBox.setOnKeyReleased(SearchBar.this);
	...
	public void handle(Event arg0) {
		KeyEvent event = (KeyEvent) arg0;
		 ...
		 if(event.getCode()==KeyCode.ENTER) {
			 ...
			 this.c.resultatRecherche(this.comboBox.getEditor().getText());
